...
{
    setComplete ([...complete,{completeText:"THANKS FOR BEING HERE.YOUR VISIT IS COMPLETED!"}])
    setLastState('');
    setIncrement("4");
 }
        ...
        return(
            <SafeAreaView  style={{fontFamily:'Inter-Black',}}>
                    <View style={{height:50,width:100, backgroundColor:'green',flex:1, borderRadius:5, alignItems:'center', justifyContent:'space-between',margin:'auto'}}>
                        <Text style={{color:'white',justifyContent:'center', alignItems:'center',fontFamily:'Inter_900Black',fontSize:20,padding:10,}}>Stage: {increment}</Text>
                    </View>
                    <View>
