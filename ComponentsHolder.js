...
const ComponentsHolder = () => {
          ...
          const onConformed = () => {
                    setNextState([
                              ...
                              {
                                        text:
                                                  "people are ahead of you,your estimated time is 4-0 hours",
                              },
                    ]);
                    setText("");
                    setIncrement("2");
          ...
          const onProceed = () => {
                    setLastState([
                              ...lastState,
                              { lasttext: "Have You Seen By the Doctor?" },
                    ]);
                    setNextState("");
                    setIncrement("3");
          };
          const onReset = () => {
                    setText([
                              ...
                              {
                                        text2:
                                                  "Would you like to Join the Virtual Queue",
                              },
                    ]);
                    setNextState("");
                    setLastState("");
          ...
          const onLastStateConform = () => {
                    setComplete([
                              ...
                              {
                                        completeText:
                                                  "THANKS FOR BEING HERE.YOUR VISIT IS COMPLETED!",
                              },
                    ]);
                    setLastState("");
                    setIncrement("4");
